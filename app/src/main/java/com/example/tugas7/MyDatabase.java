...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    public void CreateKapal(Kaos data){
    ...
    public List<Kaos> ReadKapal() {
        List<Kaos> listMhs = new ArrayList<Kaos>();
    ...
    public int UpdateKapal (Kaos data){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(tb_kapal_nama, data.get_nama());
        values.put(tb_kapal_jenis, data.get_jenis());
    ...
    public void DeleteKapal(Kaos data){
        SQLiteDatabase db = this.getWritableDatabase();
